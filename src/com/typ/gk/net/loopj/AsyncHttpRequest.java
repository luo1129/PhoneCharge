	...
	private void makeRequest() throws IOException {
		if (!Thread.currentThread().isInterrupted()) {
			try {
				...
				//XLog.i("AsyncHttpRequest client start execute：", "联网开始");
				
				HttpResponse response = client.execute(request, context);
				
				//XLog.i("AsyncHttpRequest client after execute responseCode：", String.valueOf(response.getStatusLine().getStatusCode()));
